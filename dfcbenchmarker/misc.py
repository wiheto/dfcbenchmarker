...
def load_params(in_str):
    ...
    if os.path.isfile(dfcbenchmarker.__path__[0] + '/data/routine_params/' + str(in_str) + '.json'):
        params_path = dfcbenchmarker.__path__[0] + '/data/routine_params/' + str(in_str) + '.json'
