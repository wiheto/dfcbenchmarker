...
def load_data(data,colind = None):
    ...
    *Returns*
    ...
    return pd.read_csv(dfcbenchmarker.__path__[0] + '/data/data/' + data + '_data.csv',index_col=np.arange(0,colind))
...
def gen_data_sim3(params,mi='alpha'):
    ...
    *RETURNS*
    ...
    if params['hrf_path'] == 'hrf_TR2':
        hrf_saved = np.load(dfcbenchmarker.__path__[0] + '/data/hrf/hrf_TR2.npy')
...
def gen_data(simparams):
    ...
    simulations={'sim-1':dfcbenchmarker.gen_data_sim1,'sim-2':dfcbenchmarker.gen_data_sim2,'sim-3':dfcbenchmarker.gen_data_sim3,'sim-4':dfcbenchmarker.gen_data_sim4}
